/*
 * generated from C:/Users/raghu/eclipse-workspace/ef/src/main/resources/fm/spec/form/form1.xlsx at 2019-07-26T00:29:39.864
 */
...
export class Form1 extends Form {
	...
	customerId = new Field('customerId', 1, 'customer Id', null, 'Customer Id', null, true, false, false, false,
				0, '[A-Z]{3}-[\\d]{2}-[A-Z]{3}', 'invalidCustId', 10, 10, 0, 0, null, null, null, null, null);
	financialYear = new Field('financialYear', 2, 'Financial Year', null, 'financial year', null, true, true, false, false,
	...
	fromDate = new Field('fromDate', 4, 'From Date', null, 'from field', null, false, true, false, false,
				4, null, 'invalidFutureDate', 0, 0, 1, 73000, null, null, null, null, null);
	toDate = new Field('toDate', 5, 'To Date', null, 'to field', null, false, true, false, false,
				4, null, 'invalidFutureDate', 0, 0, 1, 73000, null, null, null, null, null);
	...
	state = new Field('state', 10, 'State', null, 'State', null, true, true, false, false,
				0, '[A-Z][A-Z]', 'invalidState', 2, 2, 0, 0, null, null, null, [
				['Karnataka', 'KA'],
				['Tamil Nadu', 'TN'],
				['Telengana', 'TS']
			],null);
	district = new Field('district', 11, 'District', null, 'District', null, true, true, false, false,
	...
	kaSpecificField = new Field('kaSpecificField', 12, 'Mother Tongue', null, 'Mother Tongue', null, false, true, false, false,
				0, null, 'invalidText', 2, 100, 0, 0, null, null, null, null, null);
	aadhaar = new Field('aadhaar', 13, 'Aadhaar', null, 'Aadhaar', null, false, true, false, false,
				1, null, 'invalidAadhaar', 0, 0, 100000000000, 999999999999, null, null, null, null, null);
	pan = new Field('pan', 14, 'pan', null, 'Pan', null, false, true, false, false,
