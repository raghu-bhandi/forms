 ...
 * <br />
 * generated at 2019-08-30T23:09:24.167 from file
 * C:/Users/raghu/eclipse-workspace/ef/src/main/resources/fm/spec/form/form1.xlsx
 */
public class Form1 extends Form {
	...
	private static final String UNIQUE = " WHERE header_id=?";
	...
	private static final int[] UNIQUE_IDX = { 0 };
	private static final int[] UPDATE_IDX = { 2, 3, 4, 5, 6, 7, 9, 10, 11, 12, 13, 0 };
	...
	private void setDbMeta() {
		...
		m.uniqueClause = UNIQUE;
		m.uniqueParams = this.getParams(UNIQUE_IDX);
		m.updateClause = UPDATE;
		m.updateParams = this.getParams(UPDATE_IDX);
		m.deleteClause = DELETE;
		m.generatedColumnName = "header_id";
	...
	public Form1() {
		...
		Field[] flds = {
				new Field("headerId", 0, DefinedDataTypes.id, null, null, true, false, null, "header_id",
						ColumnType.GeneratedPrimaryKey),
				new Field("customerId", 1, DefinedDataTypes.customerId, "AAA-99-AAA", null, true, true, null,
						"customer_id", ColumnType.UniqueKey),
				new Field("financialYear", 2, DefinedDataTypes.fy, "2010", null, true, true, null, "financial_year",
						ColumnType.RequiredData),
				new Field("boolField", 3, DefinedDataTypes.trueFalse, "true", null, true, true, null, "bool_field",
						ColumnType.RequiredData),
				new Field("fromDate", 4, DefinedDataTypes.futureDate, "44175", null, true, true, null, "from_date",
						ColumnType.RequiredData),
				new Field("toDate", 5, DefinedDataTypes.futureDate, "44896", null, true, true, null, "to_date",
						ColumnType.RequiredData),
				new Field("intField1", 6, DefinedDataTypes.qty, "33", null, false, true, null, "int_field1",
						ColumnType.OptionalData),
				new Field("intField2", 7, DefinedDataTypes.qty, "45", null, false, true, null, "int_field2",
						ColumnType.OptionalData),
				new Field("fyStartDate", 8, DefinedDataTypes.date, null, null, false, false, null, null, null),
				new Field("state", 9, DefinedDataTypes.state, "KA", null, true, true, "states", "state",
						ColumnType.RequiredData),
				new Field("district", 10, DefinedDataTypes.district, "123", null, true, true, null, "district",
						ColumnType.RequiredData),
				new Field("kaSpecificField", 11, DefinedDataTypes.text, "kannada", null, false, true, null,
						"ka_specific_field", ColumnType.OptionalData),
				new Field("aadhaar", 12, DefinedDataTypes.aadhaar, "111122223333", null, false, true, null, "aadhaar",
						ColumnType.OptionalData),
				new Field("pan", 13, DefinedDataTypes.pan, "ACTPB3029K", null, false, true, null, "pan",
						ColumnType.OptionalData) };
		this.fields = flds;

		ChildForm[] chlds = { new ChildForm("orderLines", "form2", true, 1, 200, "wrongLines") };
	...
	public static void main(String[] args) {
		Form1 f = new Form1();
		DbMetaData meta = f.dbMetaData;
		System.out.println("meta.=" + meta.selectParams[0]);
	}
}
